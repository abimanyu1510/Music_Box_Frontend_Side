        ...
        >
          ...
          <div className="flex items-center w-full justify-center gap-3">
            <div className="bg-red-300 px-3 rounded-md">
              <button className="text-headingColor text-sm"
              onClick={() =>deleteAlbumObject(data._id)}>
                Yes
                </button>
            </div>
            <div
            ...
            >
              <button className="text-headingColor text-sm">No</button>
            </div>
          </div>
        </motion.div>
      )}
